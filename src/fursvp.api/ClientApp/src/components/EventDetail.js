                        ...
                        React.createElement(reactstrap_1.ModalBody, null,
                            ...
                            React.createElement(reactstrap_1.TabContent, { activeTab: _this.props.editEventModalActiveTab },
                                React.createElement(reactstrap_1.TabPane, { tabId: "editEventDetailsTab" },
                                    React.createElement(reactstrap_1.FormGroup, null,
                                        React.createElement(RsvpTextInput, { label: "Event Name", id: "eventName", required: true })),
                                    React.createElement(reactstrap_1.FormGroup, null,
                                    ...
                                    React.createElement(reactstrap_1.FormGroup, null,
                                        React.createElement(RsvpTextInput, { label: "Time Zone", id: "timeZoneId", required: true })),
                                    React.createElement(reactstrap_1.FormGroup, null,
                                        React.createElement(RsvpTextInput, { label: "Location", id: "location", required: true })),
                                    React.createElement(reactstrap_1.FormGroup, null,
                                        React.createElement(RsvpTextInput, { label: "Other Details", id: "otherDetails", required: true }))),
                                ...
                                React.createElement(reactstrap_1.TabPane, { tabId: "editEventPublishTab" },
                                    React.createElement(reactstrap_1.FormGroup, null,
                                        React.createElement(RsvpCheckbox, { label: "Publish", id: "isPublished" })),
                                    React.createElement(reactstrap_1.FormGroup, null,
                                        React.createElement(RsvpCheckbox, { label: "Open RSVPs", id: "rsvpOpen" })),
                                    formik.values.rsvpOpen
                                        ? React.createElement(reactstrap_1.FormGroup, null,
                                            React.createElement(RsvpDateTimePicker, { label: "Close RSVPs At", id: "rsvpClosesAt" }))
                                        : React.createElement(React.Fragment, null)))),
                        React.createElement(reactstrap_1.ModalFooter, null,
                            React.createElement(reactstrap_1.TabContent, { activeTab: _this.props.editEventModalActiveTab },
                                React.createElement(reactstrap_1.TabPane, { tabId: "editEventDetailsTab" },
